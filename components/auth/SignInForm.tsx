...
import { ApiResponse, User } from "@/app/types/types";
...
//     >
//       <h1 className="mb-4 text-2xl font-bold text-black text-center">Login</h1>
        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Ingresa tu email y constraseña para iniciar sesión!
            </p>

            {/* MOSTRAR ERROR AQUÍ */}
            {errorMsg && (
              <div className="mb-4 mt-4 p-2 bg-red-100 border-l-4 border-red-500 text-red-700 text-sm">
                {errorMsg}
              </div>
            )}
          </div>
